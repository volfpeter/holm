...
@pytest.mark.parametrize(
    ...
    (
        # -- No inner layout.
        (
            "without-layout/inner?no_inner_layout=true",
            "GET",
        ...
        (
            "without-layout/inner?no_middle_layout=false&no_inner_layout=true",
            "GET",
            RenderedPage.no_inner_layout,
        ),
        (
        ...
        # -- No middle layout.
        (
            "without-layout/inner?no_middle_layout=true",
            "GET",
        ...
        # -- No root layout.
        (
            "without-layout/inner?no_root_layout=true",
            "GET",
