...
- `app/`: the application package, the one `holm` walks. Files become routes by convention: `page.py` is a page, `layout.py` or `layout.jinja` wraps pages, `actions.py` is HTML fragment endpoints (a natural fit for HTMX).
